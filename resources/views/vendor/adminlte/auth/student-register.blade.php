...
@section('auth_header', __('Create a Student Account'))

@section('auth_body')
    <form action="{{ route('process.student.register') }}" method="post">
        @csrf
        ...
        {{-- Email field --}}
        <div class="input-group mb-3">
            <input type="registration_no" name="registration_no" class="form-control @error('registration_no') is-invalid @enderror"
                   value="{{ old('registration_no') }}" placeholder="{{ __('Registration No.') }}">

            <div class="input-group-append">
                <div class="input-group-text">
                    <span class="fas fa-warehouse {{ config('adminlte.classes_auth_icon', '') }}"></span>
                </div>
            </div>
        ...
        {{-- Email field --}}
        <div class="input-group mb-3">
            <input type="department" name="department" class="form-control @error('department') is-invalid @enderror"
