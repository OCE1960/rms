    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form>
          ...
          <input type="hidden" class="form-control" id="verify-fee" name="verify-fee" value="">
            ...
            <div class="form-group col-md-12">
                ...
                <div class="form-group col-md-12">
                    <label for="result">Consent Letter</label>
                    <input type="file" class="form-control-file" id="result">
                </div>
                ...
                let url = "{{ route('verify.result.requests') }}";
                 $.ajax({
                    ...
                    error : function(response, textStatus, errorThrown){
                        ...
                        $('.spms-loader').hide();
                        $('#save-new-verify-result-request').attr('disabled', false);
                        $('.backend-json-response').html('');
