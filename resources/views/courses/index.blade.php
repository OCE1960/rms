...
@section('content')
    ...
    @include('courses.modals.add-student-modal')
    @include('courses.modals.edit-student-modal')
    @include('courses.modals.view-student-modal')
    @include('modals.reset-password-modal')
    @include('courses.modals.bulk-upload-student-modal')
