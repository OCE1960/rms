  ...
  <div class="modal-dialog modal-lg " role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="roleModalLable">Dispatch  <strong>{{ ($selectedTask) ? $resultVerificationRequest->studentFullname() : "" }} </strong> Result </h5>
                ...
                <form class="mt-1">
                    ...
                    <div id="role_error" class="backend-json-response"></div>
                      ...
                      <div class="form-row">
                        ...
                        <input type="hidden" class="form-control" id="dispatch-verify-result-request-id" name="verify-result-request-id" value="{{ (($resultVerificationRequest)) ? $resultVerificationRequest->id : '' }}"> 
