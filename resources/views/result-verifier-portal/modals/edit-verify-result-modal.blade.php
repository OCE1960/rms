    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form>
          ...
          <input type="hidden" class="form-control" id="edit-verify-fee" name="verify-fee" value="{{$verifyResultFee}}">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-12 mt-2">
                  ...
                  <div class="custom-file">
                    <input type="file" class="custom-file-input" id="edit-result">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click','#update-verify-result-request',function(e) {
                ...
                //console.log($('#edit-result')[0].files[0]);
