  ...
  <div class="modal-dialog modal-xl " role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="roleModalLable">Verify <strong>{{ ($selectedTask) ? $resultVerificationRequest->studentFullname() : "" }} </strong> Result </h5>
                ...
                <form class="mt-5">
                    ...
                    <div id="role_error" class="backend-json-response"></div>
                      ...
                      <div class="form-row">
                        ...
                        <input type="hidden" class="form-control" id="verify-result-request-id" name="verify-result-request-id" value="{{ ($resultVerificationRequest) ? $resultVerificationRequest->id : '' }}">
